...
- **Email** : contact@annuaire-france-hotel.fr
...
### Couleurs (Vert Emerald)
- Couleurs primaires: `primary-50` à `primary-900` (emerald #10b981)
- Couleurs accent: `accent-400` à `accent-600` (teal #14b8a6)
