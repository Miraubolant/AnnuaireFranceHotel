<?php
/**
 * Configuration Annuaire France Hôtel
...
// ============================================
define('SITE_NAME', 'annuaire-france-hotel.fr');
define('SITE_DOMAIN', 'annuaire-france-hotel.fr');
define('SITE_URL', 'https://annuaire-france-hotel.fr');
define('SITE_TAGLINE', 'Hôtels & Hébergements en France');
define('SITE_DESCRIPTION', 'Trouvez les meilleurs hôtels et hébergements partout en France. Réservez votre séjour idéal au meilleur prix.');
...
define('SERVICES_TOITURE', [
    [
        'titre' => 'Hôtels & Hébergements en France',
        'icon' => '🏡',
...
// ============================================
$allNetworkSites = [
    ['url' => 'https://annuaire-france-hotel.fr', 'nom' => 'Annuaire France Hôtel', 'anchor' => 'Chambres d\'hôtes & Gîtes'],
];
